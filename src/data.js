...
export const phases = [
  {
    ...
    days: [
      { day: "Monday", focus: "Strength — Upper Body", icon: "💪", detail: "Free weights. 3 rounds: bicep curls, shoulder press, bent-over row, chest press on floor. Light weight, 10–12 reps each.", exercises: ["bicepCurl","shoulderPress","bentOverRow","chestPress"] },
      ...
      { day: "Thursday", focus: "Strength — Lower Body (Knee-Safe)", icon: "🏋️", detail: "Seated leg lifts, standing side leg raises, glute bridges (lying flat — no knee stress), wall sits (partial). 3 rounds, 12 reps.", exercises: ["seatedLegLift","sideLegsRaise","gluteBridge","wallSit"] },
      ...
      { day: "Saturday", focus: "Pilates-Inspired Core", icon: "✨", detail: "Standing Pilates focus. Hundred (standing), standing leg circles, pelvic tilts (lying), dead bug, heel slides. No child's pose, minimal kneeling.", exercises: ["standingHundred","legCircle","pelvicTilt","deadBug","heelSlides"] },
  ...
  },
  {
    ...
    days: [
      { day: "Monday", focus: "Strength — Upper Body + Core", icon: "💪", detail: "Add tricep kickbacks and lateral raises. Increase weight slightly. Add 2 sets of dead bug or standing oblique crunches. 25 min total.", exercises: ["bicepCurl","shoulderPress","bentOverRow","tricepKickback","lateralRaise","deadBug","standingOblique"] },
      ...
      { day: "Wednesday", focus: "Yoga — Standing & Chair", icon: "🧘", detail: "Warrior I & II, Tree pose, Standing Forward Fold (bent knees), Chair pose, Goddess. Use a chair for balance. No floor kneeling required.", exercises: ["warriorI","warriorII","treePose","forwardFold","chairPose","goddess"] },
      { day: "Thursday", focus: "Strength — Lower Body", icon: "🏋️", detail: "Add resistance band to glute bridges. Introduce Romanian deadlifts with dumbbells (hip hinge, knee-friendly). 3–4 rounds.", exercises: ["gluteBridge","romanianDeadlift"] },
      ...
      { day: "Saturday", focus: "Full Body Circuit", icon: "⚡", detail: "6 exercises, 40 sec on / 20 sec rest. Dumbbell swing, standing march, bent-over row, lateral step, shoulder press, glute bridge. 3 rounds.", exercises: ["dumbbellSwing","standingMarch","bentOverRow","lateralStep","shoulderPress","gluteBridge"] },
  ...
  },
  {
    ...
    days: [
      { day: "Monday", focus: "Strength — Push Day", icon: "💪", detail: "Floor chest press, shoulder press, tricep extensions, Arnold press. Heavier weight, 8–10 reps. 4 rounds. 25–30 min.", exercises: ["chestPress","shoulderPress","tricepExtension","arnoldPress"] },
      ...
      { day: "Wednesday", focus: "Pilates Flow", icon: "✨", detail: "30 min standing Pilates. Plié squats, standing oblique work, Pilates stance heel raises, supine work on mat (no kneeling). Leg pull front standing variation.", exercises: ["plieSquat","standingOblique","heelRaises","deadBug"] },
      { day: "Thursday", focus: "Strength — Pull + Hinge", icon: "🏋️", detail: "Dumbbell rows, Romanian deadlifts, lat pulldown (band), reverse fly. 4 rounds, 10 reps. Strong back = strong posture.", exercises: ["dumbbellRow","romanianDeadlift","latPulldown","reverseFly"] },
      ...
      { day: "Saturday", focus: "Yoga + Strength Hybrid", icon: "🧘", detail: "Warrior flow, chair pose hold, standing balance, then finish with dumbbell work: curls, press, lateral raise. 30 min total.", exercises: ["warriorI","warriorII","standingBalance","bicepCurl","shoulderPress","lateralRaise"] },
